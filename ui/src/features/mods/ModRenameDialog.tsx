...
//
// Renaming the entry in place was tried against the live API and refused:
// `PATCH /data/mod/{id}` answers "UpdatePermission Denied" even to the mod's
// own uploader, because Elide denies a field carrying no `@UpdatePermission`
// and `Mod.displayName` carries none. Publishing a copy is not a shortcut
// taken here, it is the only thing FAF allows.
//
