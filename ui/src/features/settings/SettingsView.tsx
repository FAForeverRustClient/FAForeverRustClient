...
export function SettingsView() {
  ...
  const visible = {
    ...
    account: matches("Account & support", "Open official FAF account-management and help resources.", "account username password steam support help community rules browser website"),
