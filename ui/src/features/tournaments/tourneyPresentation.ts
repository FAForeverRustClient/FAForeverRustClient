...
export const MATCH_STATUS_LABELS: Record<MatchStatus, MessageKey> = {
  waiting: "tournaments.matchStatus.waiting",
  ready: "tournaments.matchStatus.ready",
  live: "tournaments.matchStatus.live",
  bye: "tournaments.matchStatus.bye",
  done: "tournaments.matchStatus.done",
};
